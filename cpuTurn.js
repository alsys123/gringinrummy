...
// ********* Strategy C ***********
// NOTE: Strategy B is in a separate file

async function cpuTurnStratC() {

    log("cpuTurn - strategy C","sys");
    if (game.phase === "round-over") return;
