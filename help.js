...
/* -----------------------------------------------------------
   PAGE 1 — ABOUT & OVERVIEW (with icons + callouts)
------------------------------------------------------------ */
`
<h2>📘 About This Game</h2>

<p><strong>Gin Rummy (rev5 v2.1)</strong> is a clean, browser‑based two‑player Gin Rummy game where 
you face a CPU opponent. The interface is designed for clarity, smooth flow, and easy learning.</p>

<p>You can <strong>press the page buttons above</strong> (About / Contents / Text) to switch between 
sections. You can also scroll inside this window.</p>
...
<ul>
  ...
  <li>🔔 <strong>Knocks</strong> (deadwood ≤ knock limit)</li>
...
<p style="margin-top:12px;"><em>Version: rev5 v2.1 — Feb 2026</em></p>
`,
...
/* -----------------------------------------------------------
   PAGE 3 — SCORING, CPU, BACKDOOR, TECHNICAL (icons + callouts)
------------------------------------------------------------ */
`
<h2>🏆 Scoring</h2>
...
<ul>
  ...
  <li>Version: <strong>rev5 v2.1</strong></li>
</ul>
